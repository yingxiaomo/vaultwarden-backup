...
> ⚠️ Current data is automatically backed up before restore. If restore fails, it will be rolled back.

### Web Management Panel (dev branch only)

The dev branch includes a web management panel on port 9876 with dashboard, config management, one-click backup/restore, and live logs:
